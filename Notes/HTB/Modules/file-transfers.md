...
Par défaut avec Apache, le listage des répertoires est activé (si aucun fichier index.html n'est présent), ce qui permet à n'importe qui de voir le contenu du répertoire (risque de confidentialité). Sur Nginx, cela n'est pas activé par défaut.
