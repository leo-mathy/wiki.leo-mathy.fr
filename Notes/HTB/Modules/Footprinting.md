...
Pour synchroniser les fichiers du partage:
...
+ 		192.168.1.1 # Tous les utilisateurs de l'hôte 192.168.1.1
...
Scanner le service avec tous les scripts commençant par rdp:
