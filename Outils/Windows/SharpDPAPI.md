...
| `/mkfile:<fichier>` | Utilise la/les clé(s) de sauvegarde DPAPI au format GUID:SHA1 d'un contrôleur de domaine contenues dans un fichier pour déchifrer clés privées de certificats chiffrées avec DPAPI. |
